...
public String toString() {
	return "Match [XmlTimeSpan=" + XmlTimeSpan + ", homeSubstitutesPerTeam=" + homeSubstitutesPerTeam
			+ ", awaySubstitutesPerTeam=" + awaySubstitutesPerTeam + ", xmlTimeSpan=" + xmlTimeSpan
			+ ", matchFileTimeStamp=" + matchFileTimeStamp + ", matchResult=" + matchResult + ", matchStatus="
			+ matchStatus + ", matchFileName=" + matchFileName + ", tournament=" + tournament + ", matchIdent="
			+ matchIdent + ", matchId=" + matchId + ", homeTeamFormationId=" + homeTeamFormationId
